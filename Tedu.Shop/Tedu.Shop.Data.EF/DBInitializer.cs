...
using Tedu.Shop.Utilities.Constants;
    ...
    public async Task Seed()
    {
        ...
        if (!_context.ProductCategories.Any())
        {
            ...
            List<ProductCategory> listProductCategory = new List<ProductCategory>()
                {
                    new ProductCategory() { Id = id1, Name="Áo nam",SeoAlias="ao-nam",ParentId = null,Status=Status.Actived,SortOrder=1},
                    new ProductCategory() { Id = id2, Name="Áo nữ",SeoAlias="ao-nu",ParentId = null,Status=Status.Actived ,SortOrder=2 },
                    new ProductCategory() { Id = id3, Name="Giày nam",SeoAlias="giay-nam",ParentId = null,Status=Status.Actived ,SortOrder=3 },
                    new ProductCategory() { Id = id4, Name="Giày nữ",SeoAlias="giay-nu",ParentId = null,Status=Status.Actived,SortOrder=4 }
                };
        ...
        if (!_context.Settings.Any(x => x.UniqueCode == "HomeTitle"))
        {
        ...
        if (!_context.Settings.Any(x => x.UniqueCode == "HomeMetaKeyword"))
        {
            _context.Settings.Add(new Setting()
            {
                Id = Guid.NewGuid(),
        ...
        if (!_context.Settings.Any(x => x.UniqueCode == "HomeMetaDescription"))
        {
            _context.Settings.Add(new Setting()
            {
                Id = Guid.NewGuid(),
