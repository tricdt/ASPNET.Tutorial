...
export class CategoriesService extends BaseService {
  ...
  getDetail(id) {
    return this.http
      .get<Category>(`${environment.apiUrl}/api/categories/${id}`, { headers: this._sharedHeaders })
      .pipe(catchError(this.handleError));
  }
  ...
  getAllPaging(filter, pageIndex, pageSize) {
    return this.http
      .get<
        Pagination<Category>
      >(`${environment.apiUrl}/api/categories/filter?pageIndex=${pageIndex}&pageSize=${pageSize}&filter=${filter}`, { headers: this._sharedHeaders })
      .pipe(
  ...
  getAll() {
    return this.http.get<Category[]>(`${environment.apiUrl}/api/categories`, { headers: this._sharedHeaders }).pipe(
